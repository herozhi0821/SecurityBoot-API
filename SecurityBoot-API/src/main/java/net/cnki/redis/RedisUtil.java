...
public class RedisUtil{
	 ...
	 * HashKey 获取map中的键值
	 * @param key 键 不能为null
	 * @param item 项(map-key) 不能为null
	 * @return 值
	 */
	public Object getMapByMkey(String key,String item){
	 ...
	 * @param key 键
	 * @param item 项(map-key)
	 * @param value 值
	 * @return true 成功 false失败
	 */
	public boolean setMapByMkey(String key,String item,Object value) {
		try {
	 ...
	 * @return true 成功 false失败
	 */
	public boolean setMapByMkey(String key,String item,Object value,long time) {
		try {
			redisTemplate.opsForHash().put(key, item, value);
			if(time>0){
				expire(key, time);
	 ...
	 */
	public void deleteMapkeys(String key, Object... item){
	 ...
	 * @return true 存在 false不存在
	 */
	public boolean deleteMapkey(String key, String item){
