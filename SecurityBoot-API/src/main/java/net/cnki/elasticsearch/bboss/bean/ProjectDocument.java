...
@ESIndex(name = "projectdocument",type = "projectdocument")
public class ProjectDocument extends ESBaseData {
	...
	public ProjectDocument(String pidinfo, String filename, String projectname, String projectmember, String projectnum,
			String projectType, String company, String allContent, String researchOne, String researchTwo,
			String researchThree, String researchFour, String researchFive, Date createTime) {
		super();
		this.pidinfo = pidinfo;
		this.filename = filename;
		this.projectname = projectname;
