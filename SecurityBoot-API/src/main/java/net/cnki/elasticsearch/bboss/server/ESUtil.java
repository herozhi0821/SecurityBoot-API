...
public class ESUtil {
	 ...
	 * 添加或修改文档
	 */
	public <T> void addOrUpdateDocuments(String indexName,String indexType,List<T> list){
		//获取文档的客户端对象，单实例多线程安全
		ClientInterface clientUtil = EsClientConfig.restClient();
		//向固定index添加或者修改文档,id，否则做添加文档操作，返回处理结果
		//索引表 索引类型
		clientUtil.addDocuments(indexName,indexType,list);
	}
	/**
	 * 获取文档
	 */
	public String getDocumentById(String indexName,String indexType,String id){
		//获取文档的客户端对象，单实例多线程安全
		ClientInterface clientUtil = EsClientConfig.restClient();
		//索引表 索引类型 id
		String res = clientUtil.getDocument(indexName,indexType,id);
		return res;
	}
	/**
	 * 获取文档
	 */
	public <T> T getDocumentById(String indexName,String indexType,String id,Class<T> t){
		//获取文档的客户端对象，单实例多线程安全
		ClientInterface clientUtil = EsClientConfig.restClient();
		//索引表 索引类型 id 对象
		return clientUtil.getDocument(indexName,indexType,id,t);
	}
	/**
	 * 删除文档
	 */
	public void deleteDocumentById(String indexName,String indexType,String id){
		//获取文档的客户端对象，单实例多线程安全
		ClientInterface clientUtil = EsClientConfig.restClient();
		//索引表 索引类型 id 对象
		clientUtil.deleteDocument(indexName,indexType,id);
	}
	/**
	 * 删除文档
	 */
	 ...
	 */
	public <T> List<T> exec(String indexName,T params,String dsl){
		//获取索引对应的客户端
		ClientInterface clientUtil = EsClientConfig.restClient(indexName);
